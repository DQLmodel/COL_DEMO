-- Load CSV data into Snowflake source table
-- This will populate DQLABS_QA.STAGING.RETAIL_SALES with the raw data

-- Step 1: Clear existing data (if any)
DELETE FROM DQLABS_QA.STAGING.RETAIL_SALES;

-- Step 2: Insert the raw CSV data into the source table
